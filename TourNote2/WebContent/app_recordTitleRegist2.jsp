...
<body>
	<form id="registForm" method="post" action="${pageContext.request.contextPath}/regist_record2.do" onsubmit="return formCheck()">
	<div id="recordInfo" title="여행기 제목 입력">
		<div id="infoTitle">
				<p>등록하실 여행기의 제목을 입력해주세요.</p>
				<input type="text" name="title" id="title" style="width: 230px;">
		</div>
	</div>
