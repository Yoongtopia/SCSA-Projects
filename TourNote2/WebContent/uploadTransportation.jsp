	...
	<div id="mainDiv">			
		...
		<table width="520">
			<tr height="40">
				...
				<td colspan="4" id="infoMsg" align="center">(교통수단을 선택 후, 입력 버튼을 눌러주세요.)</td>
			</tr>
			<tr height="40">
				<td></td>
				<td width="95" align="center"><input type="button" id="airplane" value="airplane"></td>
				<td width="95" align="center"><input type="button" id="train" value="train"></td>
				<td width="95" align="center"><input type="button" id="bus" value="bus"></td>
				<td width="95" align="center"><input type="button" id="boat" value="boat"></td>
			</tr>
			<tr height="40">
				<td colspan="3" align="center"><select id="transportationList">
					<option value="none" id="noTransportation">교통수단의 종류를 선택하세요</option>
				</select></td>
				<td id="inputSelfTd" colspan="2" align="right"></td>
			</tr>
			<tr>
