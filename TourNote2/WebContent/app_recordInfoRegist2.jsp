...
<body>
	...
	<form id="registForm" method="post" action="${pageContext.request.contextPath}/end_record2.do" onsubmit="return formCheck()">
			...
			<div id="infoImage">
				...
				<c:when test="${not empty photoList }">
					<c:forEach items="${photoList }" var="photo">
						<div class="imageView" style="width: 70px; text-align: center;">
							<input type="radio" name="photoRadio" class="photoRadio" value="${photo.photoName}">
							<img class="image1" src="${pageContext.request.contextPath}/image/${photo.photoName}" width="60" height="60">
						</div>
					</c:forEach>
				</c:when>
				<c:otherwise>
