...
<form method="post" action="notice_update2.do">

<table id="update" class="ui inverted table segment" style="margin: 0 auto;  width:800px; margin-top:-50px; font-family: 'Nanum Gothic';" >>
<tr>
<td align="center" id="th1">번호</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;${board.boardNum }</td>
</tr>
<tr align="center">
<td align="center" id="th2">제목</td>
<td width="600px">
<input type="text" id="boardTitle" name="boardTitle" value="${board.boardTitle }" style="width: 550px;"/>
</td>
</tr>
<tr align="center">
<td align="center" id="th3">내용</td>
<td><textarea id="boardCont" name="boardCont" style="width: 550px; height: 450px;">
${board.boardCont }</textarea></td>
</tr>
<tr><td colspan="2" align="center">
<input type="submit" value="수정" class="ui button"/>
<a href="http://localhost:8080/FinalProject_TourNote2/board_list_notice.do?boardCategory=notice">
