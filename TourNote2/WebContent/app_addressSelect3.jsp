uploadTransportation_view_byPhoto2<%@page import="com.scsa.wapl.entity.Photo"%>
				...
				buttons: {
						'선택': function(){
								...
								if (gps == null){
									...
									var href="${pageContext.request.contextPath}/regist_gps2.do?uploadType="+uploadType+"&gps="+gps;
									location.replace(href);
								}
						},
						'뒤로': function(){
							var uploadType="${uploadType}"
							var href="${pageContext.request.contextPath}/uploadCont_view_back2.do?uploadType="+uploadType;
							location.replace(href);
						}
					},
				modal: true
		...
		<% } else { %>
			$("#address").dialog({
				...
				buttons: {
						'뒤로': function(){
							var uploadType="${uploadType}"
							var href="${pageContext.request.contextPath}/uploadCont_view_back2                           ?uploadType="+uploadType;
							location.replace(href);
						}
					},
				modal: true
