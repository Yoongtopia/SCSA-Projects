...
<form method="post" action="board_update2.do">
...
<td>
<input type="text" id="boardTitle" name="boardTitle" value="${board.boardTitle }" style="width: 550px;"/></td>
</tr>
<tr align="center">
<td align="center" id="th3">내용</td>
<td><textarea id="boardCont" name="boardCont"  style="width: 550px; height: 450px;">${board.boardCont }></textarea></td>
</tr>
