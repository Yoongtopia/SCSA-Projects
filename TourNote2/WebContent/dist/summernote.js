...
(function (factory) {
  ...
  var settings = {
    ...
    options: {
      ...
      // fontName
      fontNames: [
        'Nanum Gothic','맑은 고딕','궁서체','바탕체','Serif', 'Sans', 'Arial', 'Arial Black', 'Courier',
  ...
  var Editor = function () {
    ...
    var aCmd = ['bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript',
                ...
                'backColor', 'foreColor', 'insertHorizontalRule', 'fontName', 'fontSize'];
    ...
    this.resize = function ($editable, sValue, $target) {
      ...
      $target.css({
        ...
        height: $editable.height() * sValue + 'px'
      });
    };
