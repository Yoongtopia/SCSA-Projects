...
function pagelist(cpage){
	...
	frm.action="goTransportationUpdate.do";
	frm.submit();
}
...
<table id="update">
	...
	<c:forEach items="${transportationList}" var="list">
		<form class="mod" method="post" name="updateOrDeleteForm" action="${pageContext.request.contextPath}/updateTransportation.do" >
			<tr>
				<td><input type="text" name="transportationType" value="${list.transportationType}" readonly="readonly"/></td>
				<td><input type="text" name="transportationName" value="${list.transportationName}" readonly="readonly"/></td>
				<td><input type="text" name="countryName" value="${list.countryName}" readonly="readonly"/></td>
				<td><input type="text" name="cityName" value="${list.cityName}"/></td>
				<td>
					<input type="text" name="link" value="${list.link}"/>
					<input type="submit" id="updateTP" value="수정" />&nbsp;&nbsp;
				</td>
			</tr>
		</form>
	</c:forEach>
