...
<script type="text/javascript">
	$(function(){
		if ("${spotList.size()}" == "0"){
			var h1=$("<h4/>").text("등록된 여행 기록이 없습니다.");
			var h2=$("<h4/>").text("여행기를 삭제하고, 여행 기록을 종료하시겠습니까?");
			var h3=$("<h4/>").text("(아니오를 누르시면 기록 화면으로 이동합니다.)");
			...
			$("#endCheck").dialog({
				...
				buttons: {
						'예': function(){
							var href="${pageContext.request.contextPath}/end_yes_delete.do";
			...
			$("#endCheck").dialog({
				...
				buttons: {
						'예': function(){
							var href="${pageContext.request.contextPath}/end_yes_view.do";
							location.replace(href);
						},
						'아니오': function(){
							var href="${pageContext.request.contextPath}/end_no.do";
