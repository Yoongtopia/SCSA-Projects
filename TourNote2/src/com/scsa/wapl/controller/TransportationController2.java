...
@Controller
public class TransportationController2 {
	...
	// 교통 정보 - 비동기
	@RequestMapping("/get_transportationList2.do")
	@ResponseBody
	...
	//관리자 교통정보 수정페이지
	@RequestMapping("/goTransportationUpdate2.do")
	...
	//교통정보 삭제 페이지
	@RequestMapping("/goTransportationDelete2.do")
	...
	public String registTransportation(Transportation transportation, Model model){
		...
		return "transportationManage2.do";
	}
	
	@RequestMapping("/updateTransportation2.do")
	public String updateTransportation(Transportation transportaion){
		transportationService.modifyTransportation(transportaion);
		return "goTransportationUpdate2.do";
	}
	
	@RequestMapping("/removeTransportation2.do")
	public String removeTransportation(Transportation transportation, Model model){
		...
		return "goTransportationDelete2.do";
	}
