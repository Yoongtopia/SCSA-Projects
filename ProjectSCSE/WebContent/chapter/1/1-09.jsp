	...
	$(document).on("click", "#run", function() {
		...
		for (var i = 0; i < $sortable.length; i++) {
			if ($sortable.eq(i).attr("id") == "for") {
				...
				var ifis2 = "if((detection==13 || detection%7==6) && detection!=41){";
				code = code + ifis2;
			} else if ($sortable.eq(i).attr("id") == "ifRight") {
				var ifis = "if(detection<13){";
				code = code + ifis;
			} else {
...
<body>
	...
	<footer>
		<div id="tileBox">
			...
			<div class="voidTile"></div><div class="tile tree2"></div><div class="tile tree2"></div><div class="tile green"></div><div class="tile green" ></div><div class="tile green"></div><div class="tile green"></div><div class="tile cow"></div><div class="voidTile"></div>
			...
			<div class="voidTile"></div><div class="tile green"></div><div class="tile green fail"></div><div class="tile green fail"></div><div class="tile bush" ></div><div class="tile green"></div><div class="tile road"></div><div class="tile green"></div><div class="voidTile"></div>
			<div class="voidTile"></div><div class="tile green"></div><div class="tile green"></div><div class="tile horse"></div><div class="tile horse" ></div><div class="tile green"></div><div class="tile road"></div><div class="tile green"></div><div class="voidTile"></div>
			<div class="voidTile"></div><div class="tile green"></div><div class="tile school1"></div><div class="tile school2"></div><div class="tile green" ></div><div class="tile green"></div><div class="tile road"></div><div class="tile green"></div><div class="voidTile"></div>
			...
			<div class="voidTile"></div><div class="tile bush"></div><div class="tile bush"></div><div class="tile green"></div><div class="tile green" ></div><div class="tile green"></div><div class="tile green"></div><div class="tile green"></div><div class="voidTile"></div>
			<div class="voidTile"></div><div class="voidTile"></div><div class="voidTile"></div><div class="voidTile"></div><div class="voidTile"></div><div class="voidTile"></div><div class="voidTile"></div><div class="voidTile"></div><div class="voidTile"></div>
