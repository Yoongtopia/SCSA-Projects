...
<html>
			...
			$(document).on("click", "#run", function() {
				...
				for (var i = 0; i < $sortable.length; i++) {
					if ($sortable.eq(i).attr("id") == "ifFriend") {
						code = code + "if(detection==3 || detection==5 || detection==6 || detection==8){";
					}else if($sortable.eq(i).attr("id") == "ifEnemy") {
						code = code + "if(detection==2 || detection==4 || detection==7 || detection==9){";
	...
	<body>
		...
		<ul id="selector" class="sortable">
			...
			<li class="items startFor8" id="for"><div class="trainLink"></div></li>
