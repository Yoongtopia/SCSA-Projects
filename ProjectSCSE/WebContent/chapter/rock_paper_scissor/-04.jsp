...
<html>
	...
	<body>
		...
		<ul id="selector" class="sortable">
			<li class="items scissor" check="decision" id="setTimeout(function(){checkResult('paper','scissor');}, interval);"><div class="trainLink"></div></li>
			<li class="items rock" check="decision" id="setTimeout(function(){checkResult('paper','rock');}, interval);"><div class="trainLink"></div></li>
			<li class="items paper" check="decision" id="setTimeout(function(){checkResult('paper','paper');}, interval);"><div class="trainLink"></div></li>
		...
		<br />
		<!-- <table border="1">
			<tr><td colspan="3" width="1000" style="text-align: center">보만 내는 아코 이기기</td></tr>
