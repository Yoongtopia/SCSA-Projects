...
<html>
		...
		<script type="text/javascript">
			$(document).on("click", "#run", function() {
				...
				for (var i = 0; i < $sortable.length; i++) {
					if ($sortable.eq(i).attr("id") == "ifScissor") {
						code = code + "";
	...
	<body>
		...
		<ul id="selector" class="sortable">
			<li class="items scissor" check="decision" id="setTimeout(function(){checkResult('scissor','scissor');}, interval);"><div class="trainLink"></div></li>
			<li class="items rock" check="decision" id="setTimeout(function(){checkResult('scissor','rock');}, interval);"><div class="trainLink"></div></li>
			<li class="items paper" check="decision" id="setTimeout(function(){checkResult('scissor','paper');}, interval);"><div class="trainLink"></div></li>
		...
		<br />
	<!-- 	<table border="1">
			<tr><td colspan="3" width="1000" style="text-align: center">가위만 내는 아코 이기기</td></tr>
