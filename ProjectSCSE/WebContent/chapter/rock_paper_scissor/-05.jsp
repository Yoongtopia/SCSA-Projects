...
<html>
	...
	<body>
		...
		<ul id="board" class="sortable">
			<li class="items ifScissor" check="condition" id="ifScissor" style="z-index: 99;"><div class="trainLink"></div></li>
			<li class="items rpsEndIf" id="}" style="z-index: 99;"><div class="trainLink"></div></li>
			<li class="items ifRock" check="condition" id="ifRock" style="z-index: 99;"><div class="trainLink"></div></li>
			<li class="items rpsEndIf" id="}" style="z-index: 99;"><div class="trainLink"></div></li>
			<li class="items ifPaper" check="condition" id="ifPaper" style="z-index: 99;"><div class="trainLink"></div></li>
			<li class="items rpsEndIf" id="}" style="z-index: 99;"><div class="trainLink"></div></li>
		</ul>
		...
		<br />
		<!-- <table border="1">
			<tr><td colspan="3" width="1000" style="text-align: center">아코 이기기</td></tr>
		...
		<table id="rcpRing">
			<tr><td colspan="3" width="1000" style="text-align: center">아코 무조건 이기기</td></tr>
