	...
	<div class="large-12 columns">
		...
		<div class="row">
			<div class="large-6 small-12 columns" >
				<a class="item" id="userTerms" style="margin-right: 11%; text-decoration: none; 
					color: black;"> <i class="home icon"></i> 이용약관
				</a> 
				<a class="item" style="margin-right: 8%"> <i class="info icon"></i> 개인정보이용방침
				</a>
				<a class="item"> <i class="question icon"></i> Project SCSE?
				</a>
			</div>
			</br>
			<div class="columns" >
				<p>&copy; Samsung SCSA 2nd Team Cocococo, Project SCSE All right reserved 2014</p>
			</div>
		</div>
	</div>
		<!-- 이용약관 모달 -->
	<div class="ui basic small modal" id="terms">
		<i class="close icon" ></i>
		<div class="header" >이용 약관</div>
 		<div class="content">
 		<textarea autofocus="autofocus" draggable="false" readonly="readonly" rows="20" style="width: 100%;line-height:160%;">
제 1 장 총 칙
...
<!-- 			<div class="left">
		...
		<div class="actions">
			<div id="ok" class="ui negative blue button">확인</div>
		</div>
	</div>
