	...
	<div class="col-md-2"></div>
		<div class="col-md-8" id="mainDiv">
			<h2 style="color: #4f8c70;">
				NOTICE <font size="4em"><strong>공지사항 수정</strong></font> 
			</h2>
			<div class="row" style="padding: 18px 0 20px 0;">
				<form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath }/notice_update.do" onsubmit="return updateCheck();">
				<div style="border-bottom: 2px solid #4f8c70; border-top: 2px solid #4f8c70; 
					...
					<table class="table" style="width: 853px; border: 0; margin-bottom: 0;">
						<tr>
							...
							<td style="border: 0;">
								<input type="text" class="form-control" readonly="readonly" 
									value="${notice.member.nickname} (${notice.member.userId})"
									style="width: 300px;">
							</td>					
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border: 0;">
								<textarea class="form-control" id="noticeContent" name="noticeContent"
													rows="10" cols="100" style="resize: none; overflow-y: scroll;">${notice.noticeContent }</textarea>
							</td>
						...
						<td style="padding-top: 7px; border: 0;">
							<input type="file" name="noticeImage" id="noticeImage" style="display: inline-block; width: 185px;">
							<font color="gray">&nbsp;${notice.noticeImage}</font>
						</td>
					</tr>
					</table>
				</div>
