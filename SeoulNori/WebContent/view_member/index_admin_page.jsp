...
<script type="text/javascript">
	...
	$(function() {
		...
		if( $("#adminPageTabChk").val() != "imageUpdateTab" ){
			/* footer 높이 */
		...
		/* 관리자페이지 tab 링크 */
		$("#memberListTab").click(function() {
			location.href="${pageContext.request.contextPath}/admin_page.do?tabId=memberListTab&pageNo=1";
		}); 
		$("#stampListTab").click(function() {
			location.href="${pageContext.request.contextPath}/admin_page.do?tabId=stampListTab&pageNo=1";
		});
		$("#imageUpdateTab").click(function() {
			location.href="${pageContext.request.contextPath}/admin_page.do?tabId=imageUpdateTab&pageNo=1";
		});
		$("#myInfoTab").click(function() {
			location.href="${pageContext.request.contextPath }/admin_page.do?tabId=myInfoTab&pageNo=1";
		});
		
		
		/* 활성화시킬 탭 체크 */
		if( $("#adminPageTabChk").val() != "" ){
			$("#"+$("#adminPageTabChk").val()).parent().attr("class", "active");
		} else {
			$("#memberListTab").parent().attr("class", "active");
		}
...
<body id="mainBody" style="overflow-x: hidden;">
	...
	<div class="col-md-2">
		 ...
		 <div style="width: 100%; height: 500px; text-align: right;">
			...
			<table style="position: absolute; top:125px; right: 0; padding: 5px;">
				<tr>
					<td style="text-align: center;">
						<img src="${pageContext.request.contextPath}/images/test/${sessionScope.member.mainStamp}.png"
									width="120px" style="boder-radius:5px;">
					</td>
				</tr>
				<tr>
					<td style="text-align: center; padding: 5px; width: 131px; border-top: 1px solid #ddd;">
						<strong>${sessionScope.member.nickname}님</strong>의<br/>
						<span>관리자 페이지</span>
					</td>
				</tr>
			</table>
			...
			<div style="position: relative; top: 315px; right: -15px; overflow: hidden; border-right: 3px solid #ccc;">
				<input type="hidden" id="adminPageTabChk" value="${adminPageTabChk}">
				<ul class="nav nav-tabs-member" id="adminTab" style="position: relative; right: -50px;">
					<li>
						<a id="memberListTab" href="">
							<span class="glyphicon glyphicon-list-alt" style="font-size: large;"></span>
							&nbsp;&nbsp;회원목록
						</a>
					</li>
					<li>
						<a id="stampListTab" href="">
							<span class="glyphicon glyphicon-tower" style="font-size: large;"></span>
							&nbsp;&nbsp;스탬프관리
						</a>
					</li>
					<li>
						<a id="imageUpdateTab" href="">
							<span class="glyphicon glyphicon-camera" style="font-size: large;"></span>
							&nbsp;&nbsp;행사사진수정
						</a>
					</li>
					<li>
